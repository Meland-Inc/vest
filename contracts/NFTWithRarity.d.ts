...
interface NFTWithRarityInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(string,string,string,string)": FunctionFragment;
...
export class NFTWithRarity extends BaseContract {
  ...
  interface: NFTWithRarityInterface;
